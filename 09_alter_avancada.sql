...
CREATE DATABASE db_1410_catcafe_alterAvancada
GO

USE db_1410_catcafe_alterAvancada
GO
...
CREATE TABLE clientes (
	...
	/*
		Em resumo: "crie uma restrição chamada PK_clientes_cliente_id que torne a coluna cliente_id a chave primária da tabela"
		Isso garante a unicidade e identificação exclusiva de cada cliente na tabela clientes
	*/
	-- 
...
-- Passo 01: Remover a chave primária existente
